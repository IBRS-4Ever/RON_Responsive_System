...
Subtitle_Base_Table["ready_or_not/swatjudge/prefixtoc_0.wav"] = {
	Speaker = CharacterName, 
	SpeakerColor = CharacterColor,
	Subtitle = {
		["default"] = "Entry Team to TOC...", 
		["schinese"] = "突入组呼叫指挥中心……",
		["japanese"] = "突入班から作戦本部へ...",
...
Subtitle_Base_Table["ready_or_not/swatjudge/prefixtoc_1.wav"] = {
	Speaker = CharacterName, 
	SpeakerColor = CharacterColor,
	Subtitle = {
		["default"] = "Lead to TOC...",
...
Subtitle_Base_Table["ready_or_not/swatjudge/prefixtoc_2.wav"] = {
	Speaker = CharacterName, 
	SpeakerColor = CharacterColor,
	Subtitle = {
		["default"] = "Element to TOC...",
		["schinese"] = "战斗组呼叫指挥中心……",
...
Subtitle_Base_Table["ready_or_not/swatjudge/prefixtoc_3.wav"] = {
	Speaker = CharacterName, 
	SpeakerColor = CharacterColor,
	Subtitle = {
		["default"] = "TOC...",
...
Subtitle_Base_Table["ready_or_not/swatjudge/suspectkilled_0.wav"] = {
	Speaker = CharacterName, 
	SpeakerColor = CharacterColor,
	Subtitle = {
		["default"] = "Suspect down.",
		["schinese"] = "嫌疑人倒地。",
		["japanese"] = "容疑者ダウン。",
...
Subtitle_Base_Table["ready_or_not/swatjudge/suspectkilled_1.wav"] = {
	Speaker = CharacterName, 
	SpeakerColor = CharacterColor,
	Subtitle = {
		["default"] = "They're down!",
		["schinese"] = "他们倒地了！",
		["japanese"] = "奴らを仕留めた！",
		["korean"] = "녀석이 쓰러졌다!",
...
Subtitle_Base_Table["ready_or_not/swatjudge/suspectkilled_2.wav"] = {
	Speaker = CharacterName, 
	SpeakerColor = CharacterColor,
	Subtitle = {
		["default"] = "Suspect is down.",
		["schinese"] = "嫌疑人倒地。",
		["japanese"] = "容疑者ダウン。",
		["korean"] = "용의자가 쓰러졌다.",
...
Subtitle_Base_Table["ready_or_not/swatjudge/suspectkilled_3.wav"] = {
	Speaker = CharacterName, 
	SpeakerColor = CharacterColor,
	Subtitle = {
		["default"] = "We got a suspect down.",
		["schinese"] = "一名嫌疑人倒地。",
		["japanese"] = "容疑者を1人やった。",
		["korean"] = "용의자를 제압했다.",
...
Subtitle_Base_Table["ready_or_not/swatjudge/suspectkilled_4.wav"] = {
	Speaker = CharacterName, 
	SpeakerColor = CharacterColor,
	Subtitle = {
		["default"] = "Down.",
...
Subtitle_Base_Table["ready_or_not/swatjudge/reportdeadcivilian_1.wav"] = {
	Speaker = CharacterName, 
	SpeakerColor = CharacterColor,
	Subtitle = {
		["default"] = "We have a civilian down here.",
...
Subtitle_Base_Table["ready_or_not/swatjudge/reportdeadcivilian_2.wav"] = {
	Speaker = CharacterName, 
	SpeakerColor = CharacterColor,
	Subtitle = {
		["default"] = "We lost a civilian. Repeat, civilian killed.",
...
Subtitle_Base_Table["ready_or_not/swatjudge/reportdeadcivilian_3.wav"] = {
	Speaker = CharacterName, 
	SpeakerColor = CharacterColor,
	Subtitle = {
		["default"] = "We got a dead civilian here.",
		["schinese"] = "我们这里有平民死亡。",
		["japanese"] = "民間人が死んでいる。",
...
Subtitle_Base_Table["ready_or_not/swatjudge/reportdeadcivilian_4.wav"] = {
	Speaker = CharacterName, 
	SpeakerColor = CharacterColor,
	Subtitle = {
		["default"] = "We have one civilian down.",
...
Subtitle_Base_Table["ready_or_not/swatjudge/reportdeadcivilian_5.wav"] = {
	Speaker = CharacterName, 
	SpeakerColor = CharacterColor,
	Subtitle = {
		["default"] = "We got a dead civilian here. Notify trailers, civilian is DOA.",
...
Subtitle_Base_Table["ready_or_not/swatjudge/reportdeadcivilian_6.wav"] = {
	Speaker = CharacterName, 
	SpeakerColor = CharacterColor,
	Subtitle = {
		["default"] = "We got a deceased civilian. Requesting TEMS.",
...
Subtitle_Base_Table["ready_or_not/swatjudge/reportdeadcivilian_7.wav"] = {
	Speaker = CharacterName, 
	SpeakerColor = CharacterColor,
	Subtitle = {
		["default"] = "One civilian unresponsive.",
		["schinese"] = "一名平民无任何回应。",
		["japanese"] = "民間人1名、意識不明。",
...
Subtitle_Base_Table["ready_or_not/swatjudge/reportdeadcivilian_8.wav"] = {
	Speaker = CharacterName, 
	SpeakerColor = CharacterColor,
	Subtitle = {
		["default"] = "Reporting one civilian deceased.",
...
Subtitle_Base_Table["ready_or_not/swatjudge/reportdeadcivilian_9.wav"] = {
	Speaker = CharacterName, 
	SpeakerColor = CharacterColor,
	Subtitle = {
		["default"] = "Civilian is dead.",
		["schinese"] = "平民死亡。",
		["japanese"] = "民間人、死亡。",
		["korean"] = "시민이 죽었다.",
...
Subtitle_Base_Table["ready_or_not/swatjudge/reportdeadcivilian_10.wav"] = {
	Speaker = CharacterName, 
	SpeakerColor = CharacterColor,
	Subtitle = {
		["default"] = "One civilian down.",
		["schinese"] = "一名平民倒地。",
		["japanese"] = "民間人がやられた。",
		["korean"] = "시민 한 명이 쓰러졌다.",
		["russian"] = "Убит гражданский.",
...
Subtitle_Base_Table["ready_or_not/swatjudge/reportdeadcivilian_11.wav"] = {
	Speaker = CharacterName, 
	SpeakerColor = CharacterColor,
	Subtitle = {
		["default"] = "We have one civilian down.",
